...
<template>
  <div class="list-page">
    ...
    <section class="list-panel">
      <header class="mb-3 px-1"><h2 class="m-0 text-base font-700">فروشگاه‌ها</h2></header>
      <div v-if="shops?.length" class="scroll-container list-scroll card-stack">
        <div v-for="shop in shops" :key="shop.id" class="card grid gap-3 px-5 py-4 sm:grid-cols-[1fr_1fr_auto] sm:items-center">
      ...
      <AppEmptyState v-else class="card" title="فروشگاهی ثبت نشده" />
    </section>
  </div>
</template>
